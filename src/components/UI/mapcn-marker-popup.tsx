...
function suppressCountryLabels(map: MapLibreGL.Map) {
  ...
  for (const layer of layers) {
    ...
    if (
      ...
      try {
        ...
        // ignore missing layout properties during style swaps
      }
    }
  }
}
...
type MapFitBoundsProps = {
  ...
  maxZoom?: number;
  /** Prevent zooming out past the fitted viewport */
  lockMinZoom?: boolean;
...
function MapFitBounds({
  ...
  useEffect(() => {
    ...
    const fitToBounds = () => {
      ...
      if (hideCountryLabels) {
        suppressCountryLabels(map);
      }
    };
