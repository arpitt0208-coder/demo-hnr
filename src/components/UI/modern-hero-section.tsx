...
export function StormHeroBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden bg-[#030303]" aria-hidden="true">
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <Sparkles className="size-5 text-primary-yellow" aria-hidden="true" />
