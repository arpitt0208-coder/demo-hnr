...
/** Decorative geometric shapes + gradients — use as a background layer only */
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <Image
              src="https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=40&h=40&fit=crop&q=80"
              alt=""
              width={20}
              height={20}
