                ...
                >
                  ...
                  <div className="flex flex-1 flex-col px-4 pb-4 pt-4">
                    <div className="flex items-start gap-3">
                      <span className="flex size-9 shrink-0 items-center justify-center rounded-full border-2 border-primary-yellow bg-white shadow-[0_2px_10px_rgba(239,190,61,0.25)] transition-transform duration-300 group-hover/card:scale-105">
                        <Icon
                      ...
                      <h3 className="pt-1 text-[14px] font-extrabold leading-snug text-[#0F172A] sm:text-[15px]">
                        {card.title}
                      </h3>
                    </div>

                    <p className="mt-2 flex-1 text-[12px] font-medium leading-[1.65] text-[#64748B] sm:text-[13px]">
                      {card.description}
                    </p>

                    <span className="mt-3 inline-flex items-center gap-1.5 text-[12px] font-bold text-primary-yellow transition-colors group-hover/card:text-[#d9ad35] sm:text-[13px]">
                      {card.cta}
                      <ArrowRight
