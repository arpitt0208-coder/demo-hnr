...
export function ExploreHeroShowcase() {
  return (
    <motion.div
    ...
    >
      <div className="relative overflow-hidden rounded-[28px] bg-white px-6 pb-8 pt-10 shadow-[0_16px_48px_rgba(15,23,42,0.1)] sm:rounded-[32px] sm:px-8 sm:pb-10 sm:pt-12 lg:rounded-[36px] lg:px-10 lg:pb-12 lg:pt-14">
        <div
