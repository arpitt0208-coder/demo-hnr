...
export function HomeHeroLeft({ variant = "default" }: HomeHeroLeftProps) {
  ...
  return (
    ...
    >
      ...
      >
        {isStorm ? "WEATHER UPDATE" : "BEST SERVICES"}
      </Badge>
      ...
      >
        ...
        <span
          className={`mb-1 text-[22px] font-extrabold leading-none min-[400px]:text-[26px] sm:text-[30px] md:text-[34px] lg:text-[38px] xl:text-[40px] ${
      ...
      <motion.p
        ...
        className={`mt-5 max-w-[440px] text-[14px] font-medium leading-[1.75] lg:text-[15px] ${
          isStorm ? "text-zinc-300" : "text-[#475569]"
        }`}
      >
        {isStorm
          ? "Conditions look wet near you — plan your Himalayan ride with extra care. Our fleet stays maintained and roadside support is available 24/7, rain or shine."
