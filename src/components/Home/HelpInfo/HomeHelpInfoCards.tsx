...
const panelClass =
  "rounded-[20px] border border-[#F1F5F9] bg-white p-4 shadow-[0_4px_20px_rgba(15,23,42,0.05)] transition-shadow duration-700 hover:shadow-[0_8px_28px_rgba(15,23,42,0.08)] sm:p-6";

export function HomeHelpInfoCards() {
