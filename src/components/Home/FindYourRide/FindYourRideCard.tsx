  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex h-full w-full flex-col rounded-2xl text-inherit no-underline shadow-[0_2px_16px_rgba(15,23,42,0.04)] outline-none transition-shadow duration-500 hover:shadow-[0_16px_40px_rgba(15,23,42,0.1)] focus-visible:ring-2 focus-visible:ring-primary-yellow focus-visible:ring-offset-2"
      >
        <div className="relative z-10 flex h-[min(38vw,168px)] w-full shrink-0 items-end justify-center sm:h-[188px] md:h-[204px]">
          <Image
            src={imageSrc}
            alt=""
            width={320}
        ...
        <div className="relative -mt-9 flex min-h-[7.5rem] flex-1 flex-col justify-end rounded-2xl bg-[#f5f5f7] px-4 pb-4 pt-11 transition-colors duration-500 group-hover:bg-[#f0f0f2] sm:-mt-10 sm:min-h-[8rem] sm:rounded-[18px] sm:px-5 sm:pb-5 sm:pt-12">
